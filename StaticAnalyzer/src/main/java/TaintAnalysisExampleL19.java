...
public class TaintAnalysisExampleL19 {
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        SDG<InstanceKey> sdg = new SDG(callGraph, pa, Slicer.DataDependenceOptions.NO_BASE_NO_HEAP_NO_EXCEPTIONS, Slicer.ControlDependenceOptions.NONE);
...
//        statements.stream().filter(s -> isApplicationScope(s.getNode().getMethod().getDeclaringClass())).forEach(System.out::println);
